...
export default function CreateModel() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (provider) {
      const modelSource = new provider.eth.Contract(ModelFactory, "0x8C19b8A6d6d18cdc76539d13d08a3Cc5fFd875AD");

      await modelSource.methods
        .createModelSource(name, symbol, source, hash, labels.split(","), price)
        .send()
