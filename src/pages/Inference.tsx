  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full items-center max-w-md p-4 rounded shadow-md">
        ...
        {selectedModelData && <p className="mt-2">{selectedModelData.fhe === 'YES' ? <IoShieldCheckmarkSharp title='This model is FHE compiled' className='text-amber-200 h-8 w-8' /> : null}</p>}
