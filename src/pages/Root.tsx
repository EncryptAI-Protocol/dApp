  ...
  if (window.ethereum) {
    ...
    try {
      if (paymentToken === "0x0000000000000000000000000000000000000000") {
        // Ether payment
        await encryptAIToken.methods.buyTokens(paymentToken, paymentAmount).send({ from: accounts[0], value: paymentAmount });
      } else {
        // ERC20 token payment
        await encryptAIToken.methods.buyTokens(paymentToken, paymentAmount).send({ from: accounts[0] });
      }
